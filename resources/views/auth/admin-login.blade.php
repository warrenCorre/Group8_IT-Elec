...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .admin-note { text-align: center; margin-top: 20px; padding-top: 20px; border-top: 1px solid #3a3a3a; }
        .admin-note p { color: #ccc; font-size: 0.85rem; margin-bottom: 6px; }
        .admin-note a { color: #4a7856; text-decoration: none; }
    ...
    <div class="login-container">
        <div class="login-card">
                ...
                <div class="form-group">
                    ...
                    <div class="password-field">
                        <input type="password" name="password" id="password"
                               class="form-control" placeholder="Enter admin password" required>
            ...
            <div class="admin-note">
                <p>Members should use the member portal.</p>
