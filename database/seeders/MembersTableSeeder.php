    ...
    public function run(): void
    {
        $members = [
            [
                ...
                'skills'       => ['Full-Stack Dev', 'Team Leadership', 'Project Mgmt'],
                'member_order' => 1,
            ],
            [
                'name'         => 'Jefril Intima',
                ...
                'skills'       => ['Backend Dev', 'Database Design', 'API Dev'],
                'member_order' => 2,
            ],
            [
            ...
            [
                ...
                'skills'       => ['Frontend Dev', 'React', 'Responsive Design'],
                'member_order' => 4,
            ],
            [
                'name'         => 'Juster Loreto',
                ...
                'skills'       => ['QA Testing', 'Automation', 'Bug Tracking'],
                'member_order' => 5,
            ],
            [
                ...
                'skills'       => ['Technical Writing', 'Documentation', 'Coordination'],
                'member_order' => 6,
            ],
        ];
